...
class setup:
    def __init__(self, msis_config, iri_config, chemistry_config, path_eiscat_data, mixf = 0, no_timestamp = False):
    ...
    def _create_directory(self):
        ...
        if not os.path.isdir(self._log_directory + 'Simulation'): os.mkdir(self._log_directory + 'Simulation')
        if not os.path.isdir(self._log_directory + 'plots'): os.mkdir(self._log_directory + 'plots')
    ...
    def _copy_config(self, msis_config, iri_config, chemistry_config, path_eiscat_data):
        ...
        """
        if not os.path.isdir(self._log_directory + 'Config'): os.mkdir(self._log_directory + 'Config')
