...
% 
% integrate_continuity_equation( ne0 , model_spectrum( P , Ec(:) ) , dt , A , dE , alpha , integ_type );
% integrate_continuity_equation( mdiff(nP+1:end), model_spectrum(mdiff(1:nP),Ec(:)),dt,A,dE, alpha,integ_type)