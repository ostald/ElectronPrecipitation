...
theta_B_2012 = (90 - [78.24 82.23])*pi/180;

switch p.Results.radar
 case 'uhf'
  theta_B = theta_B_2012(1);
 case 'vhf'
  theta_B = theta_B_2012(1);
 case 'esr','42m','32m','esr42m','esr32m'
  theta_B = theta_B_2012(2);
 otherwise
  disp('Unknown radar location, setting theta_B to ~13 degrees.')
  theta_B = theta_B_2012(1);
end
