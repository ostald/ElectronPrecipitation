function AICres = ElSpec_resfun(X0,ne,stdne,ne0,A,alpha,dt,E,dE,integtype,IePrior,stdPrior,nmeas_eff,eType,eWidth,varargin)
...
if nargin > 15 && ~isempty(varargin{1})
  Ie_type = varargin{1};
  AICres = update_AICc_residuals(ne,stdne,ne0,A,alpha,dt,X0,E,dE,integtype,IePrior,stdPrior,nmeas_eff,eType,eWidth,Ie_type);
else
  AICres = update_AICc_residuals(ne,stdne,ne0,A,alpha,dt,X0,E,dE,integtype,IePrior,stdPrior,nmeas_eff,eType,eWidth);
end
