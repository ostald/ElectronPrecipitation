    ...
    [AIC2_3,polycoefs2_3,b_o2_3,n_params2_3,ne2_3,neEnd2_3,Ie2_3,exitflag2_3] = AICcFitParSeq(pp(:,(idxPartition3+1):(2*idxPartition3)),...
                                                      ...
                                                      Ie1_3(:,end),...
                                                      Directives);
    [AIC3_3,polycoefs3_3,b_o3_3,n_params3_3,ne3_3,neEnd3_3,Ie3_3,exitflag3_3] = AICcFitParSeq(pp(:,(2*idxPartition3+1):(3*idxPartition3)),...
                                                      ppstd(:,(2*idxPartition3+1):(3*idxPartition3)),...
                                                      alpha(:,(2*idxPartition3+1):(3*idxPartition3)),...
                                                      dt((2*idxPartition3+1):(3*idxPartition3)),...
                                                      neEnd2_3(:,end),...
                                                      A,...
                                                      polycoefs(:,(2*idxPartition3+1):(3*idxPartition3)),...
                                                      [],... % was: ieprior,...
                                                      [],... % was: stdprior(),...
                                                      Ie2_3(:,end),...
                                                      Directives);
...
% $$$     drawnow
    ...
    elseif AICthirds < AICFull & AICthirds <= AIChalves
      ...
      [ne1_3,neEnd1_3,Ie1_3,polycoefs1_3,best_order1_3,n_params1_3,exitflag1_3,nSteps1_3,idx_out1_3] = recurse_AICfit(ne1_3,...
                                                        ...
                                                        Ie0(:,end),...
                                                        Directives);
      [AIC2_3,polycoefs2_3,b_o2_3,n_params2_3,ne2_3,neEnd2_3,Ie2_3,exitflag2_3] = AICcFitParSeq(pp(:,(idxPartition2+1):end),...
                                                        ppstd(:,(idxPartition2+1):end),...
                                                        alpha(:,(idxPartition2+1):end),...
                                                        dt((idxPartition2+1):end),...
                                                        neEnd1_3(:,end),...
      ...
      [ne2_3,neEnd2_3,Ie2_3,polycoefs2_3,best_order2_3,n_params2_3,exitflag2_3,nSteps2_3,idx_out2_3] = recurse_AICfit(ne2_3,...
                                                        ...
                                                        Ie1_3(:,end),...
                                                        Directives);
      [AIC3_3,polycoefs3_3,b_o3_3,n_params3_3,ne3_3,neEnd3_3,Ie3_3,exitflag3_3] = AICcFitParSeq(pp(:,(idxPartition2+1):end),...
                                                        ppstd(:,(idxPartition2+1):end),...
                                                        alpha(:,(idxPartition2+1):end),...
                                                        dt((idxPartition2+1):end),...
                                                        neEnd2_3(:,end),...
