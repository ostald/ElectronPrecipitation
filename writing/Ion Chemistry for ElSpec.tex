...
%The impact of variability in the ionospheric densities on the inversion from electron density profiles to differential energy spectra during auroral precipitation is investigated. The ionospheric composition is modeled for relevant minor and major species at 80 - 150 km and combined with the ElSpec algorithm [Virtanen et al., 2018]. The results are compared to previous investigations. To handle the arising computational challenges, an iterative approach is adapted, switching between the inversion with a fixed ion composition and updating the ion composition with the ionospheric chemistry model.
...
% - ideas for plots:
% - alpha minus background (static sol., or just mean of every height bin) so to hihglight variation and correlation with ne/q/Ie?
% - NO+: IC, ElSpec not corrected for charge balance (i.e. constant), ElSpec corrected for ccharge balance (same starting densities)
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{"../log/testing/2023.04.12_13_12_43 mixf=1/plots/NO+_Density_IC_0.pdf"}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{"plots/alpha_rel_dev.png"}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{"plots/comp_alpha.png"}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{"plots/o2p-nop.png"}
...
\begin{figure}
	\centering
    	\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=1.2\textwidth]{"../log/testing/2023.04.12_13_12_43 mixf=1/ElSpec-iqt_IC_0.pdf"}
			a
    	\end{minipage}%
    	\begin{minipage}{0.5\textwidth}
        	\centering
			\includegraphics[width=1.2\textwidth]{"../log/testing/2023.04.12_13_12_43 mixf=1/ElSpec-iqt_IC_29.pdf"}
			b
    	\end{minipage}
